...
<html>
    ...
    <body>
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Bánh Ngọt AMAI</h1>
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <ul class="list-group category_block">
                            ...
                            <c:forEach items="${listC}" var="c">
                                <li class="list-group-item text-white"><a href="#">${c.name}</a></li>
                            </c:forEach>

                        </ul>
                    </div>
                    <div class="card bg-light mb-3">
                        <div class="card-header bg-success text-white text-uppercase">Khuyến mãi</div>
                        <div class="card-body">
