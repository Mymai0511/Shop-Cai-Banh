            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                        <!--    <a href="#addEmployeeModal"  class="btn button1" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Order
                                </span></a> -->
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <td>${o.cID}</td>
                        <td>${o.date}</td>
                        <td><a href="loaddetailorder?oid=${o.id}" >${o.totalmoney} </a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
